...
async function boot() {
  theme.apply();
  // Только подписка на поворот и изменение размера. Замер по экранам делает
  // render через viewport.note: заглушка ниже — короткий экран, и посчитанная
  // по ней поправка не годится ни для одного настоящего.
  viewport.watch();
  mascot.apply();

...
const paths = {
  ...
  // Шестерёнка — «Настройки» в выбранном состоянии. Многоточие означает
  // «здесь есть ещё что-то», и это была правда, пока раздел звался «Ещё».
  // Раздел переименован, а знак остался: три точки не говорят о настройках
  // ничего. Стоит только на выбранной вкладке — невыбранная остаётся
  // многоточием, чтобы ряд из пяти значков не перевешивал вправо.
  gear: [
    'M12 15.2a3.2 3.2 0 1 1 0-6.4 3.2 3.2 0 0 1 0 6.4z',
    'M19.3 14.7a1.5 1.5 0 0 0 .3 1.7l.1.1a1.8 1.8 0 1 1-2.6 2.6l-.1-.1a1.5 1.5 0 0 0-2.6 1.1v.3a1.8 1.8 0 1 1-3.6 0v-.2a1.5 1.5 0 0 0-2.7-1 1.8 1.8 0 1 1-2.6-2.6l.1-.1a1.5 1.5 0 0 0-1.1-2.6h-.3a1.8 1.8 0 1 1 0-3.6h.2a1.5 1.5 0 0 0 1-2.7l-.1-.1a1.8 1.8 0 1 1 2.6-2.6l.1.1a1.5 1.5 0 0 0 1.7.3h.1a1.5 1.5 0 0 0 .9-1.4v-.3a1.8 1.8 0 1 1 3.6 0v.2a1.5 1.5 0 0 0 2.6 1l.1-.1a1.8 1.8 0 1 1 2.6 2.6l-.1.1a1.5 1.5 0 0 0 1.1 2.6h.3a1.8 1.8 0 1 1 0 3.6h-.2a1.5 1.5 0 0 0-1.4.9z',
  ],
  // Стрелка вверх из лотка — «загрузить выписку». Отдаём файл приложению,
  // поэтому стрелка вверх: вниз означала бы, что файл получают отсюда.
  upload: ['M12 15.5V4', 'M8 8.5 12 4l4 4.5', 'M4 15.5v3a1.6 1.6 0 0 0 1.6 1.6h12.8a1.6 1.6 0 0 0 1.6-1.6v-3'],
